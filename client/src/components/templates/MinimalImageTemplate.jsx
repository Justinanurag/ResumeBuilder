...
const MinimalImageTemplate = ({ data, accentColor, fontFamily = "'Roboto', sans-serif" }) => {
  // URL Normalizer
  const formatURL = (url) => {
    if (!url) return "";
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white text-zinc-800" style={{ fontFamily }} data-font-family={fontFamily}>
