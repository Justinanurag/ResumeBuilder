      ...
      <div className="flex items-center gap-4 mt-3">
        ...
        <label className="cursor-pointer">
          {data.image ? (
            ...
            <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 ring ring-slate-300 hover:opacity-80 transition">
        ...
        {typeof data.image === "object" && (
          <div className="flex flex-col gap-1 pl-2 text-sm text-gray-800">
        ...
        return (
          <div key={field.key} className="space-y-1 mt-5">
            ...
            <input
              ...
              onChange={(e) => handleChange(field.key, e.target.value)} // ✅ FIXED e missing
