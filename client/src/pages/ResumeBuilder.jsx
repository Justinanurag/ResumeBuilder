...
const ResumeBuilder = () => {
  ...
  const handleDownload = () => {
    navigate(`/download/${resumeId}?auto=1`);
  };
          ...
          resumeData.public
            ...
            : "text-purple-600 bg-purple-50 hover:bg-purple-100"
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-purple-600 bg-purple-50 hover:bg-purple-100 rounded-lg shadow-sm transition-all duration-200"
              >
