...
const ModernTemplate = ({ data, accentColor, fontFamily = "'Roboto', sans-serif" }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white text-gray-800" style={{ fontFamily }} data-font-family={fontFamily}>
